<div class="site-section border-bottom">
 ...
 <img alt="Image" src="/local/templates/.default/images/about.jpg" class="img-fluid">
			</div>
			<div class="col-md-5 ml-auto aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
