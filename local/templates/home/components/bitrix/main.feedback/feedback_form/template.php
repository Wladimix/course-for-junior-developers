	...
	<form action="<?=POST_FORM_ACTION_URI?>" class="p-5 bg-white border" method="POST">
		...
		<div class="row form-group">
			<div class="col-md-12">
				...
				<input type="email" id="email" name="user_email" class="form-control" placeholder="<?=GetMessage("MFT_EMAIL")?>" value="<?=$arResult["AUTHOR_EMAIL"]?>">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-12">
				...
				<textarea name="MESSAGE" id="message" cols="30" rows="5" class="form-control" placeholder="<?=GetMessage("MFT_MESSAGE_PLACEHOLDER")?>"><?=$arResult["MESSAGE"]?></textarea>
			</div>
		</div>
