    ...
    <div class="container">
			...
			<form class="p-5 bg-white border" name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
				...
				<div class="row form-group">
					<div class="col-md-12 mb-3 mb-md-0">
						...
						<input type="password" name="USER_PASSWORD" maxlength="255" size="17" autocomplete="off" class="form-control">
		...
		<?elseif($arResult["FORM_TYPE"] == "otp"):?>
			...
			<form class="p-5 bg-white border" name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
				...
				<div class="row form-group">
					<div class="col-md-12 mb-3 mb-md-0">
						<label class="font-weight-bold"><?=GetMessage("auth_form_comp_otp")?></label>
						<input type="text" name="USER_OTP" maxlength="50" value="" size="17" autocomplete="off" class="form-control">
					</div>
				</div>
				...
				<table width="95%">
					...
					<tr>
						<td align="center">
							...
							<input type="submit" name="logout_butt" class="btn btn-primary  py-2 px-4 rounded-0" value="<?=GetMessage("AUTH_LOGOUT_BUTTON")?>" />
						</td>
					</tr>
				</table>
			</form>
