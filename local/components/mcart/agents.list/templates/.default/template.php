        ...
        <div class="row mb-5">
            <div class="col-12">
                <div class="site-section-title">
                    <h2><?=GetMessage("AGENTS_BLOCK_NAME");?></h2>
                </div>
            </div>
        </div>
                    ...
                    <div class="agent__card_item">
                        <div class="agent__card_info">
                            ...
                            <div class="card__info_item">
                                ...
                                <div class="name"><?=$agent["UF_TYPE_OF_ACTIVITY_VALUE"]?></div>
                            </div>
                        </div>
                    </div>
                    <?if ($userId):?>
                        <a data-id-agent="<?=$agent["ID"]?>" class="star <?=in_array($agent["ID"], $arResult["STAR_AGENTS"]) ? 'active' : ''?>">
